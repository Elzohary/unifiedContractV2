  ...
  onSubmit(): void {
    if (this.form.valid) {
      ...
      const newWorkOrder: Partial<WorkOrder> = {
        details: {
          workOrderNumber: '', // Will be generated by the service
          internalOrderNumber: '', // Will be generated by the service
          ...
          targetEndDate: formValue.details.dueDate, // Using due date as target end date initially
          location: '',
          client: '',
